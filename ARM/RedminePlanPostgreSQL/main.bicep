...
param dbVersion string = '11'
param location string = resourceGroup().location

var templateName = 'RedminePlanPostgreSQL'
...
resource plan 'Microsoft.Web/serverfarms@2022-03-01' = {
  ...
  tags: {
    ...
    DB_TYPE: 'mysql'
    DB_SERVER_FQDN: '${db.name}.postgres.database.azure.com'
    DB_SERVER_NAME: db.name
    DB_ADMIN_USER: '${dbAdminUser}@${db.name}'
    DB_URL_FORMAT: 'postgresql://{0}%40${db.name}:{1}@${db.name}.postgres.database.azure.com/{2}?sslmode=require'
  }
}
